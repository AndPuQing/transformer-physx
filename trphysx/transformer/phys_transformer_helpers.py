...
class PhysformerTrain(PhysformerBase):
    ...
    def __init__(
        self, config: PhysConfig, transformer_model: PhysformerBase = None
    ) -> None:
        """Constructor"""
    ...
    def forward(
        self, inputs_embeds: Tensor, labels_embeds: Tensor, **kwargs
        ...
        """
        outputs = self.transformer.forward(inputs_embeds=inputs_embeds, **kwargs)
